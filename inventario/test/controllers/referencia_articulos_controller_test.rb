...
class ReferenciaArticulosControllerTest < ActionController::TestCase
  ...
  test "should create referencia_articulo" do
    assert_difference('ReferenciaArticulo.count') do
      post :create, referencia_articulo: { articulo_id: @referencia_articulo.articulo_id, caja_id: @referencia_articulo.caja_id, cantidad: @referencia_articulo.cantidad, nombre_referencia: @referencia_articulo.nombre_referencia, talla: @referencia_articulo.talla, valor: @referencia_articulo.valor }
    end
  ...
  test "should update referencia_articulo" do
    patch :update, id: @referencia_articulo, referencia_articulo: { articulo_id: @referencia_articulo.articulo_id, caja_id: @referencia_articulo.caja_id, cantidad: @referencia_articulo.cantidad, nombre_referencia: @referencia_articulo.nombre_referencia, talla: @referencia_articulo.talla, valor: @referencia_articulo.valor }
    assert_redirected_to referencia_articulo_path(assigns(:referencia_articulo))
  end
